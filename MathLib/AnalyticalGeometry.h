 ...
 * described
 * by the points within the vector pnts. The method rotates both the plane
 * normal and
 ...
 * a, b and c.
 * Using the eps It is possible to test a 'epsilon' neighbourhood around the
 * triangle.
 * @param p test point
