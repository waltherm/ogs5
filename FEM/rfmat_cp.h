...
public:
	...
	//      12,13, 14  double n_1, n_2, n_3; // exponents for acidic neutral and
	//      base cases for species one
	//      append for each species another set of n_1, n_2, n_3 (up to 10 sets
	//      -> up to ten species)
