...
extern void CalcXDElementJacobiMatrix(
    long index, double r, double s, double t, double* vec, double* dj);
extern void Calc1DElementJacobiMatrix(long number, double* vec, double* dj);
extern void Calc2DElementJacobiMatrix(
    long number, double r, double s, double* erg, double* dj);
extern void CalcTransformationsMatrix(long index, double* koma, double* trans);
extern void Calc2DElementCoordinatesTriangle(long index,
                                             double* x,
                                             double* y,
                                             double* dircos);
extern void Calc3DElementJacobiMatrix(
    long number, double r, double s, double t, double* erg, double* dj);
extern void Calc2DElementJacobiMatrix_9N(
    long number, double r, double s, double* erg, double* dj);
extern void CalcTransformationsMatrix_9N(long index,
                                         double* koma,
                                         double* trans);
extern void Calc2DElementJacobiMatrixXY_9N(
    long index, double r, double s, double* invjac_t, double* dj);
extern void Calc3DElementJacobiMatrix_20N(
    long number, double r, double s, double t, double* erg, double* dj);
extern void CalcPrismElementJacobiMatrix(
    long number, double r, double s, double t, double* erg, double* dj);
...
extern void Calc2DElement_ab2rs_Coord(long index,
                                      double* erg,
                                      double a,
                                      double b);
extern void Calc2DElement_rs2ab_Coord(long index,
                                      double* erg,
                                      double r,
                                      double s);
extern void Calc2DElement_xyz2ab_Coord(
    long index, double* erg, double x, double y, double z);
extern void Calc2DElement_ab2xyz_Coord(long index,
                                       double* erg,
                                       double a,
                                       double b);
extern void Calc2DElement_ab2xyz_Vector(long index,
                                        double* vec_ab,
                                        double* vec_xyz);
extern void Calc2DElement_xyz2ab_Vector(long index,
                                        double* vec_xyz,
                                        double* vec_ab);
