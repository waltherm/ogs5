...
public:
	...
	std::vector<int> pcs_mass_idx;  // index of mass_trans order-number in
	                                // processes list, (some other process are
	                                // not mass transport)
	std::vector<int> pcs_ospecies_idx;  // index of output species order-number
	                                    // in processes list     21.01.2009
	std::vector<int> pcs_nspecies_idx;  // index of nlog-output species
	                                    // order-number in processes list
	                                    // 02.02.2009
	...
	std::vector<int> species_list_phase;  // From .cap list section, phase flag
	                                      // for species 0-solid, 1-gas,
	                                      // 2-aqueous
	...
	// input file */
	//	int heatflag;      /* if 1, heat transport is active and passed to
	// phreeqc */
	std::vector<std::string> ic_2_bc_geometry_type;  // Convert eq
