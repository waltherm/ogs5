...
public:
	...
	double permeability_porosity_updating_values[5];  // ABM: Maximum of 2
	                                                  // values in Verma-Pruess
	                                                  // case
	...
	std::string PhaseHeatedByFriction;  // In TNEQ/TES models: dissipated heat
	                                    // due to friction into solid or fluid
	                                    // energy balance
