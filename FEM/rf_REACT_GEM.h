...
public:
	...
	// problems consider many nodes)
	// Names are consistent with the DataBridge structure (also see
	// "\GEM\databr.h")
...
// MPI implementation
	...
	typedef struct
	{
		...
		*      12,13, 14  double n_1, n_2, n_3; // exponents for acidic neutral
		* and base cases for species one
	...
	unsigned int gem_nThread, gem_nbar;  // number of threads, number of threads
	                                     // + 1 (number of threads + master that
	...
	boost::mutex rwmutex;      // used to lock during write or read
	                           // operations..example gem init or write dbrs or
	                           // cout!
