...
public:
	...
	std::vector<MonodSubstruct*>
	    production; /* saves production concentrations, orders and names of
	                   species */
	...
	long currentnode;  // CB 19/10/09 This is eclusively for Brand model to
	                   // allow porosity in Inhibition constant calculation
	...
	std::vector<double> Am;  // initial specific reactive mineral surface area
	                         // m²/m³ aquifer = Am * rho_b = m²/kg *
	                         // kg/m³aquifer
...
public:
	...
	std::vector<double> Masstransfer_K; /* CB: current Mass transfer
	                                       coefficient, now saved in node
	                                       vector*/
...
public:
	...
	bool copy_concentrations;  // SB 01.2011 Flag for copying concentrations in
	                           // radial models to save reaction simulation time
	...
	std::vector<std::vector<double> > ActivityCoefficients;  //  For Mineral
	                                                         //  Dissolution,
	                                                         //  store gammas in
	                                                         //  1 data object
	int activity_model;
