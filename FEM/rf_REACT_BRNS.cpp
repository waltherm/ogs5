...
#pragma omp parallel for shared(nNodes_temp,                 \
                                num_Comp_temp,               \
                                time_step,                   \
                                cur_ts_Conc_temp,            \
                                pre_ts_Conc_temp,            \
                                boundary_flag_temp) private( \
    i, pos_x, pos_y, pos_z)
...
// Run BRNS;
//	 solverTime=0.0;
//	 if (pos_x== 0 && pos_y==0) { porosity=8; pos_z=99.9; waterSaturation=3.3;
// solverTime=7.0; cout << "solverTime passed to BRNS: " << solverTime << endl;
// }
