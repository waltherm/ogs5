 ...
 *i.e. all
 * geometric data (stored in a GEOObjects-object), all the meshes, FEM
 *Conditions (i.e.
 * Boundary Conditions, Source Terms and Initial Conditions), etc.
 * ProjectData does not administrate any of the objects, it is just a "container
 *class"
 * to store them all in one place.
 * For each class of object stored in this container exists an add-, get- and
 *remove-method.
 *
