...
public:
	 ...
	 * described
	 * by three surfaces, the first and second surfaces are the parts of bottom
	 * and the top
	 * surface of the mesh that are bounded by the projection of the polygon to
	 * the bottom
	 * and the top surface of the mesh. These two parts are linked together via
	 * a third
	 * surface.
